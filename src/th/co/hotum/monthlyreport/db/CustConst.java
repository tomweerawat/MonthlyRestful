package th.co.hotum.monthlyreport.db;
...
public class CustConst {
    ...
    public static final String BOOK_ITEM_TYPE_SRVC_NAME_TH = "กิจกรรมกีฬา";
    public static final String BOOK_ITEM_TYPE_SRVC_NAME_EN = "Sport";
    public static final String BOOK_ITEM_TYPE_PACK = "P";
    public static final String BOOK_ITEM_TYPE_PACK_NAME_TH = "แพ็คเกจ";
